defmodule GoogleCrawler.AccountsTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{email: "bob@email.com", username: "Bob"}
    @update_attrs %{email: "john@email.com", username: "John"}
    ...
    test "create_user/1 with valid data creates a user" do
      password_attrs = %{password: "123456", password_confirmation: "123456"}
      create_attrs = Map.merge(@valid_attrs, password_attrs)
